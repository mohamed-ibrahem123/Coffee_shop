    ...
    <div className="home-container">
      ...
      <section className="hero-section">
        <div className="hero-content">
          <h1 className="hero-title">Experience Premium Beverages</h1>
          <p className="hero-subtitle">
            Savor the world's finest coffees and teas, delivered to your
            doorstep.
          </p>
          <button
            className="hero-btn"
      ...
      <section className="section-container">
        ...
        <div className="categories-pagination">
          <span
            className={`pagination-bar ${categoryStart === 0 ? "active" : ""}`}
            onClick={() => setCategoryStart(0)}
          ></span>

          <span
            className={`pagination-bar ${categoryStart !== 0 ? "active" : ""}`}
            onClick={() => setCategoryStart(4)}
          ></span>
        </div>
      </section>
        ...
        <div className="offer-banner-wrapper">
          ...
          <div className="offer-banner">
            <div className="offer-left">
              <h3 className="offer-title">20% OFF Cold Brews Today!</h3>
              <p className="offer-code">Promo Code: CODED123</p>
              <button
                className="offer-btn"
                onClick={() => navigate("/products")}
              >
            ...
            <div className="offer-right">
              <img src={products[0]?.image} alt="Offer" className="offer-img" />
            </div>
          </div>
        </div>
      </section>
